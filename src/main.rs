...
fn draw_heatmap(data: Vec<u64>, size: (u32, u32), xdescr: &str, ydescr: &str, target: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn load_data(source: &str, xcol: usize, ycol: usize, size: (u32, u32)) -> Result<Vec<u64>, Box<dyn std::error::Error>> {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    draw_plot(matches.value_of("source").unwrap(),
              ...
              (
                  ...
                  matches.value_of("ysize").unwrap_or("800").parse::<u32>().unwrap()
              ))
        */
...
/*
    // set up matrix
    let mut matrix = Array2::<u64>::zeros(size);
*/
}
